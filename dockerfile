...
RUN apt-get update && apt-get install -y qt5-qmake qt5-qmake:armhf qtbase5-dev:armhf qttools5-dev-tools:armhf qtbase5-dev-tools:armhf libpulse-dev:armhf \
	...
	libopenal-dev:armhf qtmultimedia5-examples:armhf libmagick++-6.q16-dev:armhf 
...
libbz2-dev:armhf libjack-jackd2-dev:armhf libvpx-dev:armhf cdbs gtk-doc-tools:armhf libzvbi-dev:armhf libzbar-dev:armhf libxvidcore-dev:armhf \
...
libopenexr-dev:armhf libopenal-dev:armhf libofa0-dev:armhf libmpcdec-dev:armhf libmodplug-dev:armhf libmms-dev:armhf \
